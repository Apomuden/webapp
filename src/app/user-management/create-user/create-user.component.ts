...
export class CreateUserComponent implements OnInit, OnDestroy {
  ...
  userForm = this.fb.group({
    ...
    contactInfo: this.fb.group({
      ...
      altCode: ['+233'],
      altNumber: [null, [Validators.minLength(9), Validators.maxLength(9), Validators.pattern(/^\d{8,}$/)]],
      number: [null, [Validators.required, Validators.minLength(9), Validators.maxLength(9), Validators.pattern(/^\d{8,}$/)]],
    ...
    emergency: this.fb.group({
      ...
      countryCode: ['+233'],
      countryCodeTwo: ['+233'],
      number: [null, [Validators.minLength(9), Validators.maxLength(9), Validators.pattern(/^\d{8,}$/)]],
      numberTwo: [null, [Validators.minLength(9), Validators.maxLength(9), Validators.pattern(/^\d{8,}$/)]],
